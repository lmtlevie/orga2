...
*/
#define VIRT_PAGE_OFFSET(X) 0xFFF & X // 12 bits mas bajos
#define VIRT_PAGE_TABLE(X)  0x3FF & (X >> 12) // 12-21
#define VIRT_PAGE_DIR(X)    0x3FF & (X >> 22) // // 10 bits mas altos
#define CR3_TO_PAGE_DIR(X)  0xFFFFF & X //Limpiar CR3
