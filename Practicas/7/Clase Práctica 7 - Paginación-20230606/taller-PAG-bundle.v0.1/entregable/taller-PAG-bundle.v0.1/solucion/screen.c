...
{
  screen_draw_box(0, 0, VIDEO_FILS, VIDEO_COLS, 0, 0); /* Limpia pantalla */
  screen_draw_box(0, 0, 14, VIDEO_COLS, 0, C_BG_BLUE);
  screen_draw_box(14, 0, 29, VIDEO_COLS, 0, C_BG_BROWN);
  screen_draw_box(29, 0, 40, VIDEO_COLS, 0, C_BG_BLUE);
  print("Aguante bokita :)", 32, 21, 0xF);
}
